...
QA_PREBUILT="
	...
	opt/minecraft-launcher/chrome-sandbox
...
src_install() {
	...
	doexe *.so chrome-sandbox minecraft-launcher

	make_wrapper "${PN}" /opt/minecraft-launcher/minecraft-launcher /opt/minecraft-launcher/
