...
src_unpack() {
	...
	# add patch for poppler 0.59+
	cp ${FILESDIR}/20170524-poppler-059.patch ${WORKDIR}/patches/100_all_20170524-poppler-059.patch || die "failed to add patches"
	echo "100_all_20170524-poppler-059.patch" >> ${WORKDIR}/patches/series
}
