...
KEYWORDS="~amd64 ~x86"
SLOT="0"
IUSE="boost cg coprocessing development doc examples ffmpeg mpi mysql nvcontrol openmp offscreen plugins python +qt5 sqlite tcl test tk +webkit"
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DPARAVIEW_BUILD_QTWEBKIT="$(usex webkit)"
