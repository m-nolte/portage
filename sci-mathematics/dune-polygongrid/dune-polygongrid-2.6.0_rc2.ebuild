...
SRC_URI="https://gitlab.dune-project.org/martin.nolte/${PN}/repository/archive.tar.gz?ref=v2.6.0rc2 -> ${P}.tar.gz"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="alberta arpack doc gmp istl metis mpi parmetis python suitesparse superlu ug vc"
...
DEPEND="=sci-mathematics/dune-grid-2.6*[alberta=,gmp=,metis=,mpi=,parmetis=,ug=,vc=]
		doc? ( app-doc/doxygen
               ...
               virtual/latex-base )
		python? ( =sci-mathematics/dune-python-2.6*[alberta=,arpack=,gmp=,istl=,metis=,mpi=,parmetis=,suitesparse=,superlu=,ug=,vc=] ${PYTHON_DEPS} )
